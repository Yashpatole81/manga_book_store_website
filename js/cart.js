...
const addCartToHtml = () => {
    ...
    if (carts.length > 0) {
        carts.forEach(cart => {
            ...
            var imageElement = document.querySelector('.product[data-id="' + cart.product_id + '"] img');
            var h3Element = document.querySelector('.product[data-id="' + cart.product_id + '"] h2');
            var h2Element = document.querySelector('.product[data-id="' + cart.product_id + '"] p');
            ...
            newCart.innerHTML = `
                ...
                <div class="totalPrice">Rs.${h2Value * cart.quantity}</div>
                <div class="quantity">
...
/*document.addEventListener("DOMContentLoaded", function () {
    ...
    searchBox.addEventListener("input", function () {
        ...
        productSections.forEach(function (section) {
            const productName = section.querySelector("h2").innerText.toLowerCase();
